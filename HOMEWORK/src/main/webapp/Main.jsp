					...
					<li class="list-group-item tree-closed">
						...
						<ul style="margin-top:10px;display:none;">
							<li style="height:30px;">
								<a href="admin?method=toQuizManager"><i class="glyphicon glyphicon-user"></i> 问答管理 </a> 
							</li>
							<li style="height:30px;">
								<a href="admin?method=toUserManager"><i class="glyphicon glyphicon-king"></i> 人员管理 </a> 
							</li>
						</ul>
					</li>
				</ul>

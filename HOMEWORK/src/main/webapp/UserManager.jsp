...
<!--    					      <button type="button" class="btn btn-success btn-xs" onclick="toAssignPage('+(user.id)+')"><i class=" glyphicon glyphicon-check"></i></button> -->
   					      <%-- <a  class="btn btn-primary btn-xs" href="toEditPage?id=${item.id }"><i class=" glyphicon glyphicon-pencil"></i></a> --%>
   						  <a  class="btn btn-danger btn-xs" href="deleteCustomer?id=${user.id }"><i class=" glyphicon glyphicon-remove"></i></a>
   					  </td>
   	                </tr>
             	</c:forEach>
			  <tfoot>
